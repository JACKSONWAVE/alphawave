...
import { ArrowRight, BarChart3, Bot, Calculator, CheckCircle2, FileText, Landmark, LineChart, Scale, Sigma, TableProperties, TrendingUp } from 'lucide-react';
...
export default function AdvisoryDashboard(){
  ...
  const modules=[
    ...
    {title:'Valuation Lab',cn:'多方法估值',detail:'DCF、Trading Comps、SOTP、Football Field与敏感性。',to:'/capital/valuation',icon:Scale,status:'与三表动态联动'},
    {title:'IPO Financing',cn:'融资估值与股权稀释',detail:'Pre-money、Post-money、募资额、发行价格、发行股数和稀释比例。',to:'/capital/ipo',icon:Landmark,status:'与DCF股权价值联动'},
    ...
    {title:'Research Report',cn:'专业研究报告',detail:'汇总行业、盈利预测、DCF、可比公司、催化剂及风险，并支持打印或另存PDF。',to:'/capital/report',icon:FileText,status:'报告模板已上线'},
